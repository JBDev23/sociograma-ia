// apps/frontend/src/components/ProjectFilters.tsx
"use client";
...
export default function ProjectFilters() {
  ...
  // Función para actualizar la URL (con un pequeño debounce para no saturar al escribir)
  useEffect(() => {
    const timer = setTimeout(() => {
      ...
      // startTransition ayuda a que Next.js no bloquee la UI mientras hace el fetch al server
      startTransition(() => {
